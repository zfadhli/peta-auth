...
export function defineOAuthGitHubEventHandler(
  ...
  return async (request: Request): Promise<Response> => {
    const config: OAuthGitHubConfig = {
      authorizationURL: 'https://github.com/login/oauth/authorize',
      tokenURL: 'https://github.com/login/oauth/access_token',
      apiURL: 'https://api.github.com',
      authorizationParams: {},
      ...userConfig,
      clientId: userConfig.clientId || process.env.PETA_OAUTH_GITHUB_CLIENT_ID,
      clientSecret: userConfig.clientSecret || process.env.PETA_OAUTH_GITHUB_CLIENT_SECRET,
    }
